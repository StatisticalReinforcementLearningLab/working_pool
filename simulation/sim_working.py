    ...
    for case in cases:
        ...
        for pn in range(1):
            ...
            for sim in range(sim_start,sim_end):
                pop_size=32
                experiment = study.study(dist_root,pop_size,'_short_unstaggered',which_gen=case,sim_number=sim,pop_number=pn,time_condition=time_cond)
                ...
                if not correct:
                    cend = '_inc'
                filename = '{}{}/population_size_{}_update_days_{}_{}_static_sim_{}_pop_{}_sanitytwo{}time_cond{}.pkl'.format('{}{}/'.format(write_directory,algo_type),case,pop_size,u,'short',sim,pn,cend,time_cond)
