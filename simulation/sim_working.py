    ...
    for case in cases:
        ...
        for epsilon in [0.1]:
            ...
            for sim in range(sim_start,sim_end):
                ...
                filename = '{}{}/population_size_{}_update_days_{}_{}_static_sim_{}_pop_{}_{}94unstaggered_group_time_cond{}{}.pkl'.format('{}{}/'.format(write_directory,algo_type),case,pop_size,u,'short',sim,pn,time_cond,cend,eps)
