    ...
    for time in experiment.study_days:
        ...
        if time==experiment.last_update_day+pd.DateOffset(days=global_policy_params.update_period):
            ...
            if global_policy_params.decision_times>2:
                ...
                #model_updates.update(algo_type,experiment,time,global_policy_params,personal_policy_params)
        ...
        for person in experiment.dates_to_people[time]:
            ...
            ###here where I get the posterior
            
            ##maybe won't need simple bandits here at all any more
            ##obtain_posteriors.get_posterior(algo_type,participant,global_policy_params,personal_policy_params,time)
